...
class NursingResearchAgent(BaseAgent):
    ...
    def _create_tools(self) -> List:
        ...
        # Personal library for searching user's uploaded documents
        personal_library_tools = create_personal_library_tools_safe()
        ...
        self._tool_status = {
            ...
            'personal_library': personal_library_tools is not None,
        }
